...
if(isset($_POST['submit']))
{
	...
	if($order== "Yes"){
	$sql="UPDATE out_of_order SET room_no= '$room', out_of_order ='$order', reason_order='$reason_order', comment_order='$comments_order' WHERE Id='$bid' ";
	}
	else{
	$sql="UPDATE out_of_order SET room_no= '$room', out_of_order ='$order', reason='$reason', comments='$comments' WHERE Id='$bid' ";
	}
