 						...
 						<?php
								...
								while($row2 = mysql_fetch_array($res)){
									...
									echo '<input type="text" id="c_'.$j.'_id" hidden="hidden" value="'.$id.'"/>
									   ...
									   <input type="text" id="c_'.$j.'_comments" disabled="disabled" style="width:30%;margin-top:10px" name="c_amount" value="'.$comments.'"/><button type="button" id="c_'.$j.'" style="margin-left:10px" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Edit</button><br/>';
								$j = $j + 1;
								}
								?> 
