...
$row = mysql_fetch_array($result);
			...
			$order=$row["out_of_order"];
				...
				$insert = "INSERT INTO maintenance (o_id, room_no, out_of_order, reason_order, comment_order, date, time, user_id) VALUES ('$kd','$room','$order','$reason','$comments', NOW(), NOW(), '$u_id')";
