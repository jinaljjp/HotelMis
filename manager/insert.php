...
$u_id = $_SESSION['user_id'];
	...
	$db=mysql_select_db('workspace',$conn) or die('Database doesnot exist');
							...
							$note = $_POST['note'];
								...
								$sql="UPDATE  payment  SET cash ='$cash', ame_ex = '$ame_ex', discovery = '$disc', visa = '$visa', master = '$masters', cheque = '$cheque', expedia = '$expedia', other = '$other', date = NOW(), time = NOW(), user_id = '".$u_id."'";
