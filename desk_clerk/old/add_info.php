...
<div id="head">
       ...
       <form name="Order" action="" method="post" id="order"> 
			...
			<ul class="form-page clearfix ng-scope ui-sortable" id="sortable0" index="0" sortable=""><!-- ngRepeat: element in Page -->
                 ...
                 <strong>Name:</strong><br/><input type="text" style="width:20%"  value="<?php echo $row1["Username"]; ?>" name="name" id="name" ><br/>
                  <strong>Email Id:</strong><br/><input type="email"  style="width:20%"   value="<?php echo $row1["email_id"]; ?>" name="e_id" id="e_id"><br/>
                  <strong>Phone No:</strong><br/><input type="tel" style="width:20%"    value="<?php echo $row1["ph_no"]; ?>" name="ph_no" id="ph_no"><br/>
