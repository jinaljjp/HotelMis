...
<div id="content" class="container_16 clearfix">
 <h2 align="center">Maid Report</h2>
         ...
         <style>
				...
				.btnAction{padding: 5px 10px;background-color: #09F;border: 0;color: #FFF;cursor: pointer; }
		</style>
        <script>
...
<input class="btnAction" type="button" name="back" id="back" value="Back" style=" align-content:center">
